...
function App() {
  ...
  const convert = () => {
    ...
    if (currencyInfo[to]) {
      ...
      setConvertedAmount(newConvertedAmount.toFixed(3));
    }
  };
        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          >
            ...
            <div className="relative w-full h-0.5">
              <button
                type="button"
                className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-blue-600 text-white px-2 py-0.5 transition hover:scale-105"
                onClick={swap}
              >
                swap
              </button>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg transition border-2 border-white hover:scale-105"
            >
